...
/**Function subtract(): subtracts two numbers from the input and displays the answer */
function subtract() {}

/**Function divide(): divides two numbers from the input and displays the answer */
function divide() {}

/**Function multiply(): multiplies two numbers from the input and displays the answer */
function multiply() {}
